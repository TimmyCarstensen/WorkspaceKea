	...
	public CreateCottage(final Resort resort, final Main main){
		...
		btnOk.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
					if(FilledOutFields){
						resort.createCottage(typeOfCottage, txtName.getText(), Integer.parseInt(txtPrice.getText()), Integer.parseInt(txtBeds.getText()));
						JOptionPane.showMessageDialog(null, "Cottage is created!");
